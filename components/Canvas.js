...
function Canvas() {
  ...
  const toggleIsEditingNewGroupName = () =>
    setIsEditingNewGroupName(!isEditingNewGroupName);
  ...
  useEffect(() => {
    ...
    toast(
      <span>
        Built by&nbsp;
        <a href={socialLink.linkTree} target="_blank">
          Shashwat Bagaria
        </a>
      </span>,
      {
      ...
      {taskModal.show && (
        <TaskModal
          ...
          handleDeleteTask={handleDeleteCard(
            taskModal?.info.groupId,
            taskModal?.info.taskId
          )}
                  ...
                  >
                    ...
                    <Tooltip tooltipText="Add new task" placement="top">
                      <button
                        ...
                        className={`${s.addNewTask} ${s.addNewTaskPlus}`}
                      >
                        +
                      </button>
                    </Tooltip>
                          ...
                          {(provided, snapshot) => (
                            ...
                            >
                              ...
                              >
                                {task?.isNew ? (
                                  <div
                                    className={`${s.newTitleWrapper} ${s.newTaskTitleWrapper}`}
                                  >
                                    <input
                                      ref={taskInputRef}
                                      name="newTaskTitle"
